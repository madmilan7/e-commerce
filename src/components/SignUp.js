...
const SignUp = () => {
    ...
    return (
        <div className='flex justify-center items-center bg-gray-50 h-fit'>
            <form className='w-11/12 md:w-fit h-fit p-12 mx-6 my-12 md:m-12 shadow-xl bg-white'>
                <h2 className='text-left mb-10 font-bold text-3xl text-purple-700'>Sign Up</h2>
                <div className='flex flex-col mb-2 h-20'>
                    <label className='text-sm md:text-base text-left mb-1 text-gray-400'>Name</label>
                    <input
                        type="text"
                        name="name"
                        onChange={changeHandler}
                        onFocus={focusHandler}
                        className={`w-11/12 md:w-80 h-8 px-3 border-slate-300 
                ...
                <div className='flex flex-col mb-2 h-20'>
                    <label className='text-sm md:text-base text-left mb-1 text-gray-400'>Confirm Password</label>
                    <input
                        type="password"
                        name="confirmPass"
                        onChange={changeHandler}
